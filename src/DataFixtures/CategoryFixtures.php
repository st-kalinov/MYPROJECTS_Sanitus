...
//
   private static $names = [
       'Royal Canin', 'Brit', 'Purina Pro Plan', 'Orijen',
       'Суха храна', 'Консервирана', 'Паучове и пастети','Органична храна', 'Универсална храна за риби', 'Храна на люспи за риби', 'Храна на гранули', 'Храна за средни папагали', 'Храна за големи папагали', 'Храна за вълнисти папагали',
       'Поводи и нагръдници', 'Купички и поставки', 'Легла', 'Намордници', 'Драскалки и катерушки', 'Помпи и външни филтри за аквариуми', 'Препарати и стабилизатори за аквариуми', 'Волиери и клетки за папагали и птици', 'Хранили и Поилки за папагали и гълъби',
       'Витамини и добавки', 'Устна хигиена', 'Противопаразитна защита',
       'Аквариуми', 'Поставки и шкафове за аквариуми'
       ];


    private static $categories = [
        'Кучета_Марки' => ['Royal Canin', 'Brit', 'Purina Pro Plan'],
        ...
        'Кучета_Козметика и грижа' => ['Витамини и добавки', 'Устна хигиена'],

        'Котки_Марки' => ['Royal Canin', 'Brit', 'Purina Pro Plan', 'Orijen'],
        'Котки_Храни' => ['Суха храна', 'Консервирана', 'Органична храна'],
        'Котки_Аксесоари' => ['Купички и поставки', 'Драскалки и катерушки'],
        'Котки_Козметика и грижа' => ['Витамини и добавки', 'Противопаразитна защита', 'Устна хигиена'],

        'Риби_Храни' => ['Универсална храна за риби', 'Храна на люспи за риби', 'Храна на гранули'],
        'Риби_Аксесоари' => ['Помпи и външни филтри за аквариуми', 'Препарати и стабилизатори за аквариуми'],
